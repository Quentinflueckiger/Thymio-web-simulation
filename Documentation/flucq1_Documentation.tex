...
\begin{table}{p{1cm} p{1cm} p{1cm} p{1cm}}
...
\begin{longtable}{p{5mm}|p{2cm}|p{4cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}}
  ...
  16.5 & Prepare to Submit & Check spelling mistake, check images, print it, put the project on a USB stick & High &  &  &  & To Do\\ \hline
\end{longtable}

\subsubsection{Seventh Sprint}
\textbf{2020-01-17 until 2020-01-end}
\begin{longtable}{p{5mm}|p{2cm}|p{4cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}}
  ID                     & Story Name & Story / Task Description & Priority & Est. Effort {[}h{]} & Update Effort {[}h{]} & Actual Effort{[}h{]} & Status                \\ \hline
  17 & Prepare Defense & Prepare the defense & High &  &  &  & To Do \\ 
\end{longtable}
