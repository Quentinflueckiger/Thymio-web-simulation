...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{./Blockly/basic_variable}
...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{./Blockly/basic_logic}
...
To do so open the location of Thymio, the downloaded not the installed, and select thymio_blockly, and then index.
