...
Hack via .aesl as we execute the code if some code with malicious is fed we still execute it.
...
As a user, I want to uplaod an .aesl file, so that I can witness the simulated behaviour. \\
Description:\\
